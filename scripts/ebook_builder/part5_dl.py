# Part V: Deep Learning Architectures (Chapters 22 - 26)
...
$$\mathcal{L}_{\text{BCE}}(\mathbf{w}) = -\frac{1}{N} \sum_{i=1}^N \left[ w_{\text{pos}} y_i \log(\hat{y}_i) + (1-y_i) \log(1-\hat{y}_i) \right]$$
