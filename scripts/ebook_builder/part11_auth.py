# Part XI: Authentication, Authorization & Security (Chapters 49 - 51)
...
$$\text{TOTP}(K, T) = \text{Truncate}\left(\text{HMAC-SHA-1}\left(K, \left\lfloor \frac{T - T_0}{T_X} \right\rfloor\right)\right)$$
